...
class SolarAppV1:
    ...
    def create_cred_tab(self):
        frame = ttk.Frame(self.notebook)
        self.notebook.add(frame, text="Расчёт средней стоимости и т.д.")
    ...
    def calculate_average(self):
        ...
        # разбиваем по запятым, пустые куски (например от двойной запятой) выкидываем
    ...
    def convert_currency(self):
        ...
        if amount >= 999999:
            messagebox.showerror("Ошибка","Больше 999999 Нельзя!")
            return
    ...
    def create_info_tab(self):
        ...
        info_text.insert(
            ...
            "1.0.21-Добавлена вкладка Расчёт средней стоимости и т.д."
        )
