...
class SolarAppV1_1:
    ...
    def __init__(self, root):
        ...
        self.tema_label = ttk.Label(top_bar, text="Сменить тему", cursor="hand2")
        self.tema_label.pack(side="left", padx=10, pady=5)
        self.tema_label.bind("<Button-1>", self.toggle_tema)
    ...
    def toggle_tema(self, event=None):
        messagebox.showinfo("Разработка", "В разработке")
    ...
    def create_conv_tab(self):
        ...
        ttk.Button(
            ...
            command=lambda: messagebox.showinfo(
                "Шпаргалка",
                "USD-Доллар,EUR-Евро,RUB-Рубль,KZT-Тенге,UAH-Гривна,"
                "GBP-Фунт стерлингов,CNY-Юань,TRY-Турецкая лира,"
                "GEL-Лари,BYN-Белорусский_рубль,KGS-Сом,UZS-Сум,CHF-Франк,JPY-Иена"
            )
    ...
    def create_info_tab(self):
        ...
        info_text.insert(
            ...
            "1.0.25BETA-Официальный релиз и переход в Бета, Добавленна gmail, сделан свой сайт (solar-app.cyou),бновление виджетов,сделана смена темы(недоконца)"
        )
    ...
    def create_help_tab(self):
        ...
        ttk.Label(frame, text="Почта Проекта:").pack(pady=5)
        help_entry = ttk.Entry(frame, justify="center")
        help_entry.insert(0, self.GMAIL)
        help_entry.config(state="readonly")
        help_entry.pack(pady=5)

        ttk.Label(frame, text="Сайт Проекта:").pack(pady=5)
        help_entry = ttk.Entry(frame, justify="center")
        help_entry.insert(0, self.SITE)
        help_entry.config(state="readonly")
        help_entry.pack(pady=5)
